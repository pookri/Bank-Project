...
INSERT INTO TRANSACTION_TYPE VALUES('CK','Check',6.00);
INSERT INTO TRANSACTION_TYPE VALUES('SOD','Savings_default_charge',10.00);
INSERT INTO TRANSACTION_TYPE VALUES('BSDC','BCHRG_SVNGS_DEFAULT_CREDIT',10.00);
commit;
...
INSERT INTO account VALUES ( 
      7602998644,'CS631','MM',120000.0,0.0,SYSDATE-300,0.0);
INSERT INTO account VALUES ( 
      8605116423,'ORBT','MM',206050.0,1.9,SYSDATE-100);
INSERT INTO account VALUES ( 
      8010169884,'CS631','LN',300000.0,0.0,SYSDATE-900,0.0);
INSERT INTO account VALUES ( 8012988712,'CS631','CKNGS',105000.0,0.0,SYSDATE-1500,300);
INSERT INTO account VALUES ( 
      8010865512,'CS631','SVNGS',300000.0,0.0,SYSDATE-900,0);
commit;

INSERT INTO customer_account VALUES(1579864322,8012988712,SYSDATE);
INSERT INTO customer_account VALUES(1579864322,8010865512,SYSDATE-1600);
INSERT INTO customer_account VALUES(1975612381,8010865512,SYSDATE-500);
INSERT INTO customer_account VALUES(0178666959,7602998644,SYSDATE-100); 
INSERT INTO customer_account VALUES(1220364547,8010169884,SYSDATE-800);
INSERT INTO customer_account VALUES(2449613350,8010169884,SYSDATE-800);
INSERT INTO ASSIST VALUES(258369147,1579864322);
INSERT INTO ASSIST VALUES(258369147,1975612381);
INSERT INTO ASSIST VALUES(258369147,0178666959);
INSERT INTO ASSIST VALUES(201536984,1220364547);
INSERT INTO ASSIST VALUES(201536984,2449613350);
...
INSERT INTO BRANCH VALUES ( 
    'CS631','Computer Science', 0,'41,north brunswick','Central JERSERY','NJ',00816);
INSERT INTO MANAGAR VALUES(140200366,896857741,'CS631');

INSERT INTO employee VALUES ( 
      140200366, 'CS631','Jui','Suthar' , 7320051699, '1-MAY-2018');
INSERT INTO employee VALUES ( 
      896857741, 'CS631','Parul','Gandhi' , 7658423910, '12-MAY-2018');
commit;      
INSERT INTO employee VALUES ( 
      258369147, 'CS631','Rocky','Black' , 7954858999, '19-DEC-2017');      
INSERT INTO employee VALUES ( 
      120356100, 'BARBO','Parul','Gandhi' , 7658423910, '12-MAY-2018');
      
INSERT INTO employee VALUES ( 
      201536984, 'CS631','Abhishek','Dutta', 7600987562, '2-DEC-2012');
...
INSERT INTO transaction VALUES(163952086,'WD',150.0,CURRENT_TIMESTAMP,SYSDATE,TRN_SC_NUM.nextval);      
commit;      
...
INSERT INTO customer_account VALUES(1579864322,7601564211,SYSDATE);
INSERT INTO customer_account VALUES(1579864322,8604579231,SYSDATE-1600);
INSERT INTO customer_account VALUES(1975612381,7601564211,SYSDATE-500);
INSERT INTO customer_account VALUES(0178666959,8605116423,SYSDATE-100); 
INSERT INTO customer_account VALUES(1220364547,8010169884,SYSDATE-800);
...
truncate table assist;
truncate table customer_account;
truncate table employee_dependent;
truncate table loan;
truncate table overdraft;
truncate table transaction;
truncate table balance_logs;
commit;
...
select changed_balance from balance_logs b,transaction t where t.transaction_account_number=b.account_number AND t.transaction_date='';